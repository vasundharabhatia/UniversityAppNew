...
class MentorsControllerTest < ActionController::TestCase
  ...
  test "should create mentor" do
    assert_difference('Mentor.count') do
      post :create, mentor: { Age: @mentor.Age, Bio: @mentor.Bio, DOB: @mentor.DOB, Name: @mentor.Name, Sex: @mentor.Sex }
    end
  ...
  test "should update mentor" do
    patch :update, id: @mentor, mentor: { Age: @mentor.Age, Bio: @mentor.Bio, DOB: @mentor.DOB, Name: @mentor.Name, Sex: @mentor.Sex }
    assert_redirected_to mentor_path(assigns(:mentor))
  end
